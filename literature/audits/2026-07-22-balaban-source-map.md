...
- [Note
  ...
  term shares the source radius.
- [Note
  0025](../../research/notes/0025-conditioned-mark-routing.md) supersedes
  the earlier transformed-mark reading after direct inspection of Eqs.
  (2.3), (2.5), (2.6), (2.8), and (2.14). The localized mark remains
  \(W_{k,p}(A,B)\) on the conditional interior \(B\), independent of the
...
- [Note 0015](../../research/notes/0015-fixed-patch-physical-composition.md)
  ...
  interface, support, mesh, and common-chart premises. Note 0028 replaces
  the discrete-tree-lift premise by a repository periodic-endpoint lemma and
  supplies zero halos for first-stage direct-\(J\) support; the source does
