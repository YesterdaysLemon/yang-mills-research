...
| Tree metric | RG I p. 257 defines \(d_j\) as the shortest contained continuous-space tree meeting every cube, divided by \(M\), and says a shortest cube-edge graph exists | This equals Note 0023's piecewise-linear contained-tree metric under its standard one-vertex degenerate-tree convention |
